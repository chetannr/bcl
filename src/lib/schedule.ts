...
export const SCHEDULE: DaySchedule[] = [
  {
    ...
    matchCount: 12,
    matches: [
      { slot: 1, time: '7:00 AM', team1: 'Monsters', team2: 'YKR', group: 'B' },
      { slot: 2, time: '7:50 AM', team1: 'Riders', team2: 'Bulldozers', group: 'A' },
      { slot: 3, time: '8:40 AM', team1: 'Titans', team2: 'OG', group: 'B' },
      { slot: 4, time: '9:30 AM', team1: 'Phoenix', team2: 'USA', group: 'A' },
      { slot: 5, time: '10:20 AM', team1: 'Super Kings', team2: 'Sharks', group: 'B' },
      { slot: 6, time: '11:10 AM', team1: 'Riders', team2: 'RCB', group: 'A' },
      { slot: 7, time: '12:00 PM', team1: 'Titans', team2: 'Sharks', group: 'B' },
      { slot: 8, time: '12:50 PM', team1: 'Phoenix', team2: 'Riders', group: 'A' },
      { slot: 9, time: '1:40 PM', team1: 'YKR', team2: 'Super Kings', group: 'B' },
      { slot: 10, time: '2:30 PM', team1: 'USA', team2: 'Royal Tiger', group: 'A' },
      { slot: 11, time: '3:20 PM', team1: 'Monsters', team2: 'OG', group: 'B' },
      { slot: 12, time: '4:10 PM', team1: 'Phoenix', team2: 'Bulldozers', group: 'A' },
    ],
  },
  {
    date: '25 Jan',
